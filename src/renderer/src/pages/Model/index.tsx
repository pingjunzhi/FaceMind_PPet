...
const Model = () => {
  ...
  useEffect(() => {
    const fetchAudio = async () => {
      const response = await fetch('https://nijigen.com.cn/api/dialogue/new_trends/', {
        ...
        headers: {
          ...
          'guanli': 'feier' // �滻Ϊʵ�ʵ�����ͷ����ֵ
        },
        body: JSON.stringify({
          prefix: '弘远', // �滻Ϊʵ�ʵ�prefix����ֵ
          gs_id: 1500, // �滻Ϊʵ�ʵ�gs_id����ֵ
          bot: '花火', // �滻Ϊʵ�ʵ�bot����ֵ
          trend_tag: '<query>' // �滻Ϊʵ�ʵ�trend_tag����ֵ
        })
      });
    ...
    const intervalId = setInterval(fetchAudio, 10000); // ÿ5�뷢��һ�����󲢲�����Ƶ
    return () => clearInterval(intervalId); // �����ʱ��
  }, []);
